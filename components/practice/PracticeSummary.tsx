...
import { CheckCircle2, XCircle, RefreshCw, Home, Loader2, AlertTriangle, Flag, RotateCcw } from "lucide-react";
    ...
    <div className="card" style={{ padding: 32, textAlign: "center" }}>
      ...
      >
        ...
        <Link href={exitHref} style={{ textDecoration: "none" }}>
          <Button variant="outline" size="lg" leftIcon={Home} fullWidth>
            {exitLabel}
          </Button>
        </Link>
      </div>
